# behavioural_interview_local_company

বাংলাদেশি কোম্পানির behavioural প্রশ্নের প্রস্তুতি: ছয়টা STAR story লেখা, ৯০ সেকেন্ডে জোরে বলা, আর যেকোনো প্রশ্নে খাটানো — তিন বাজারের (প্রোডাক্ট, আউটসোর্সিং, স্টার্টআপ) জোর বুঝে। `switch_in_6_month_local_company`-এর story-র কাজ দিন ধরে এখানে সরানো (ব্যবহারকারীর সিদ্ধান্ত ২০২৬-০৯-১৫) — plan-এ থাকে শুধু ঘর আর লিংক, রোজের ইংরেজি আর mock interview plan-এই। সাথে `behavioural_interview`-এর ২৫টা ডক, এই সাইটেই।

এটা তিনটা স্বাধীন পথের একটা — [রিমোট](https://sojibrd.github.io/behavioural_interview_remote_company/) আর [গ্লোবাল](https://sojibrd.github.io/behavioural_interview_global_company/) আলাদা সাইট, প্রতিটা শূন্য থেকে শুরু। তিন পথেই ছয়টা story; পথ বদলালে বদলায় জোর।

**লাইভ:** https://sojibrd.github.io/behavioural_interview_local_company/

## Functional Requirement

- **আজ (`/`):** প্রথমবার খুললে শুরুর তারিখ জিজ্ঞেস করে — প্রস্তাব ২০২৬-০৯-১৯, plan-এর দিন ০০৬। তারপর দেখায় ক্যালেন্ডারের আজকের দিন, এই ক্রমে: জমে থাকা ⚑ → আজকের ঝালাই → আজকের দিন।
...
| [docs/04-company-variants.md](docs/04-company-variants.md) | ০৮৬–১১৫ · dip | একই প্রশ্ন, তিন বাজার |
...
`brainstorming/ASSUMPTIONS.md` → `brainstorming/` (`behavioural-how-many-paths.md`) → `switch_in_6_month_local_company/docs/` → এই ফোল্ডার। সাইটের দিন = plan-এর দিন − ৫ — plan-এর story-র ঘর আর এই সাইটের দিন একসাথে বদলান।
...
| key | মান |
|---|---|
| `lbi:v1:start` | শুরুর তারিখ `"YYYY-MM-DD"` |
| `lbi:v1:task` | কাজ শেষের তারিখ। id = দিন + কাজের **লেখা** থেকে hash |
| `lbi:v1:check` | দিন শেষ (`d007`) ও ব্লক শেষ (`b1`)-এর হ্যাঁ/না |
| `lbi:v1:review` | 🔁 ঝালাইয়ের অবস্থা `{ base, step }` |
