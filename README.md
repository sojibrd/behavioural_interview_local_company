...
বাংলাদেশি কোম্পানির behavioural প্রশ্নের প্রস্তুতি: ছয়টা STAR story লেখা, ৯০ সেকেন্ডে জোরে বলা, আর যেকোনো প্রশ্নে খাটানো — তিন বাজারের (প্রোডাক্ট, আউটসোর্সিং, স্টার্টআপ) জোর বুঝে। `switch_local_company_in_6_month`-এর story-র কাজ দিন ধরে এখানে সরানো (ব্যবহারকারীর সিদ্ধান্ত ২০২৬-০৯-১৫) — plan-এ থাকে শুধু ঘর আর লিংক, রোজের ইংরেজি আর mock interview plan-এই। সাথে `behavioural_interview`-এর ২৫টা ডক, এই সাইটেই।
...
`brainstorming/ASSUMPTIONS.md` → `brainstorming/` (`behavioural-how-many-paths.md`) → `switch_local_company_in_6_month/docs/` → এই ফোল্ডার। সাইটের দিন = plan-এর দিন − ৫ — plan-এর story-র ঘর আর এই সাইটের দিন একসাথে বদলান।
